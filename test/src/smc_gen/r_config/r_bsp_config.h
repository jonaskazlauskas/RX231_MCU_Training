...
/* Package type. Set the macro definition based on values below:
   ...
   FP           = 0x0             = LFQFP/100/0.50   100-pin LFQFP (PLQP0100KB-A) 0.5 mm pitch,  14 * 14 mm
   LF           = 0x1             = WFLGA/64/0.50     64-pin WFLGA (PWLG0064KA-A) 0.5 mm pitch,   5 * 5 mm
   FM           = 0x2             = LFQFP/64/0.50     64-pin LFQFP (PLQP0064KB-A) 0.5 mm pitch,  10 * 10 mm
   ND           = 0x5             = HWQFN/64/0.50     64-pin HWQFN (PWQN0064KC-A) 0.5 mm pitch,   9 * 9 mm
   FL           = 0x6             = LFQFP/48/0.50     48-pin LFQFP (PLQP0048KB-A) 0.5 mm pitch,   7 * 7 mm
   NE           = 0x7             = HWQFN/48/0.50     48-pin HWQFN (PWQN0048KB-A) 0.5 mm pitch,   7 * 7 mm
   LA           = 0x9             = TFLGA/100/0.50   100-pin TFLGA (PTLG0100KA-A) 0.5 mm pitch, 5.5 * 5.5 mm
*/
...
*/
#define BSP_CFG_MCU_PART_VERSION        (0xB) // <-- Updated by GUI. Do not edit this value manually
...
/* USB Clock source select (UPLLCR.UCKUPLLSEL).
   ...
   1 = USB PLL Circuit
*/ 
#define BSP_CFG_USB_CLOCK_SOURCE        (0) // <-- Updated by GUI. Do not edit this value manually
...
*/
#define BSP_CFG_PLL_MUL                 (13.5) // <-- Updated by GUI. Do not edit this value manually

/* USB PLL Input Frequency Divider Select (UPLIDIV).
   Available divisors = /1 (no division), /2, /4
*/
#define BSP_CFG_UPLL_DIV                (2) // <-- Updated by GUI. Do not edit this value manually

/* USB PLL Frequency Multiplication Factor Select (USTC).
   Available multipliers = x4, x6, x8, x12
*/
#define BSP_CFG_UPLL_MUL                (12) // <-- Updated by GUI. Do not edit this value manually
...
/* The HOCO can operate at several different frequencies. Choose which one using the macro below.
   ...
   3 = 54MHz
*/
#define BSP_CFG_HOCO_FREQUENCY          (3) // <-- Updated by GUI. Do not edit this value manually
