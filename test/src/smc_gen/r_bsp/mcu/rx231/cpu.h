...
typedef enum
{
    /* PRC0
       ...
       MOSCCR, SOSCCR, LOCOCR, ILOCOCR, HOCOCR, OSTDCR, OSTDSR, CKOCR, UPLLCR, UPLLCR2, BCKCR, HOCOCR2 */
    ...
    /* PRC3
       Enables writing to the registers related to the LVD: LVCMPCR, LVDLVLR, LVD1CR0, LVD1CR1, LVD1SR, LVD2CR0, LVD2CR1,
       LVD2SR, VBATTCR, VBATTSR, VBTLVDICR */
    BSP_REG_PROTECT_LVD,
